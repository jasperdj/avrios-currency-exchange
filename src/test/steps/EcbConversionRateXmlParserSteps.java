...
import com.avrios.sample.exchange.service.Ecb.EcbConversionRateXmlParserService;
...
public class EcbConversionRateXmlParserSteps {
    private EcbProperties properties = new EcbProperties();
    private EcbConversionRateXmlParserService parser = new EcbConversionRateXmlParserService(properties);
    ...
    private List<ConversionRateContainer> containersResults = new ArrayList<>();
    ...
    private void processContainers(ConversionRateContainer container, LocalDate date) {
